...
//lozanoba 3/11/2024 CPS*3330 - ADD YOUR information here
WriteLine("It runs!");
// Create the connection to the resource!
//using (SqlConnection conn = new SqlConnection())
SqlConnection conn = new SqlConnection();
// Create the connectionString - USE YOUR CREDENTIALS
conn.ConnectionString = "Server = LAPTOP-BNNMCI5H\\SQLEXPRESS01; Database = Users; User Id = lozanoba; Password = 5540; ";
conn.Open();
// Create the command
SqlCommand command = new SqlCommand("SELECT * FROM AlozanoTable", conn);
int max = 0;
...
SqlCommand insertCommand = new SqlCommand("INSERT INTO AlozanoTable (UserId, UserName, UserEmail) VALUES(@0, @1, @2)", conn);
...
try
{
    ...
    SqlCommand errorCommand = new SqlCommand("SELECT * FROM AlozanoTable", conn);
